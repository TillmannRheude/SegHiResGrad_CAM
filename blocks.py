...
class Single_Conv_Block_2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, with_relu_batchnorm=True, conv_kernel_size=3, conv_padding_size=1):
        """
        Args:
...
class Conv_Block_2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, conv_kernel_size=3, conv_padding_size=1, pool_kernel_size=2, pool_stride_size=2):
        """
        Args:
            in_channels (int): Input feature channels for the convolution.
            out_channels (int): Output feature channels of the convolution.
...
class Upconv_Block_2d(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, out_channels,
                conv_kernel_size=3, conv_padding_size=1, upconv_kernel_size=4, upconv_stride_size=2, upconv_padding_size=1): #3,0,2,2
        """
        Args:
